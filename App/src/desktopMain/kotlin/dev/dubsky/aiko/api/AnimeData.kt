...
class AnimeData {
    ...
    suspend fun getByFilter(
        ...
        Logger.log(
            LogLevel.INFO,
            "API",
            "Params: page: $page, perPage: $perPage, season: $season, seasonYear: $seasonYear, status: $status, averageScore_greater: $averageScore_greater, search: $search, isAdult: $isAdult"
        )
        return response
    }
