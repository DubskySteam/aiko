...
class AnimeData {
    ...
    suspend fun getTopAiringAnimeBySeason(page: Int = 1, pagePer: Int = 10, season: MediaSeason = MediaSeason.WINTER, year: Int = 2024): ApolloResponse<TopAnimeBySeasonQuery.Data> {
        val apolloClient = buildApolloClient()
